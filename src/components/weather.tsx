...
export default function WeatherWidget() {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-gradient-to-br from-lime-600 to-lime-600">
      {/* Center the card within the screen */}
      <Card className="w-full max-w-md mx-auto text-center">
        {/* Card header with title and description */}
        <CardHeader>
        <CardTitle className="text-4xl font-bold text-blue-800 underline">Weather Widget</CardTitle>
<CardDescription className="text-2g text-gray-600 font-bold"> Search for the current weather conditions in your city.</CardDescription>
      ...
      <br></br>  <div className="text-center text-zinc-50 font-bold">
